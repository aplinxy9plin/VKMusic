...
class Global {
    ...
    static let appID = "2986065"
    
    static let currentVersion = "5.37"
    ...
    static var internetConnection = true
    ...
    enum CenterVC: String {
        ...
        case DeveloperController = "DeveloperController"
        //case SettingsController = "settingsController"
    }

    
    enum ControllersIdentifiers: String {
        case DeveloperController = "DeveloperCotroller"
